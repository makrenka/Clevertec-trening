...
import './terms-content-list.css';

export class TermsContentList extends Component {

    render(): ReactNode {
        return (
            <ol className="terms-main__content-list">
                <li className="terms-main__content-list-item">
                    ...
                    <ol className="terms-main__content-sublist">
                        <li className="terms-main__content-list-subitem">
