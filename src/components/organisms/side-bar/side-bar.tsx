                ...
                <nav className='side-bar__nav'>
                    <ul className="side-bar__pages-list">
                        <li className="side-bar__books-showcase">
                            <a href="/" className={this.isActiveLink('/')}>Витрина книг</a>
                        </li>
                        ...
                        <li className="side-bar__pages-item">
                            <a href="/terms-of-use" className={this.isActiveLink('/terms-of-use')}>Правила пользования</a>
                        </li>
                        <li className="side-bar__pages-item">
                            <a href="/contract-offer" className={this.isActiveLink('/contract-offer')}>Договор оферты</a>
                        </li>
                    </ul>
                </nav>
            </aside>
